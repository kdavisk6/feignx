...
/**
 * Contract for use with the {@link FeignTargetAnnotationProcessor}.
 */
public interface AnnotatedContract {
  ...
  <T extends Annotation> AnnotationProcessor<Annotation> getAnnotationProcessor(T annotation);

  <T extends Annotation> ParameterAnnotationProcessor<Annotation> getParameterAnnotationProcessor(
      T annotation);
